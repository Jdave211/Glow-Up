...
import { FOUNDATIONAL_LOOKSMAX_GUIDANCE, resolveGlowupModel } from './foundational-guidance';
...
const GLOWUP_MODEL = resolveGlowupModel('GLOWUP_INFERENCE_MODEL', 'GLOWUP_CHAT_MODEL');
